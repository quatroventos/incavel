...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'content' ); ?> class="page filial">
    ...
    <?php if (!empty(get_field('cabecalho'))) { ?>
        ...
        <div class="container-fluid hero" style="background-image: url('<?php the_field('cabecalho'); ?>'); height:450px; position:relative; padding:155px;">
    ...
    <div class="container container-single-product">
        <div class="row">
            <div class="col-md-6" style="position:relative; padding-bottom: 110px;">
                <h2><?php the_title(); ?></h2>
                <p><?php the_content(); ?></p>
                <a href="" class=" d-flex align-items-center contact">
    ...
    <div class="container home-produtos-container">
        <div class="row">
            <div class="col-md-1" style="position:relative">
                <h2 class="rotated-title" style="white-space:nowrap; left:-200px;">Mais Carrocerias</h2>
            </div>
            <div class="col-md-11">
                <div class="row home-produtos">
                    ...
                    $args = array(
                        'post_type' => 'carroceria', // Nome do seu custom post type
                    ...
                    while ($query->have_posts()) : $query->the_post();
                        ...
                        ?>
                        <div class="home-produto mais-carrocerias">
                            <div class="home-produto-item">
